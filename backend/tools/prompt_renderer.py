...
PROMPT_SCHEMAS: dict[str, dict] = {
    "eligibility_analysis": {
        ...
        "required": [
            "cancer_type", "cancer_stage", "biomarkers", "prior_treatments",
            "lines_of_therapy", "age", "sex", "ecog_score", "key_labs",
            "additional_conditions", "additional_notes", "nct_id",
            "brief_title", "phase", "brief_summary", "eligibility_criteria",
        ],
    },
    "patient_summary": {
        ...
        "required": [
            "cancer_type", "cancer_stage", "biomarkers", "prior_treatments",
            "lines_of_therapy", "age", "sex", "ecog_score",
        ],
    },
    "dossier_analysis": {
        "template_attr": "DOSSIER_ANALYSIS_PROMPT",
        "required": [
            "patient_json", "nct_id", "brief_title",
            "eligibility_criteria", "initial_score", "initial_explanation",
        ],
    },
    "enrollment_packet": {
        ...
        "required": [
            "patient_json", "nct_id", "brief_title",
            "revised_score", "clinical_summary", "criteria_json",
        ],
    },
    "patient_prep": {
        "template_attr": "PATIENT_PREP_PROMPT",
        "required": [
            "cancer_type", "cancer_stage", "age", "brief_title",
            "site_name", "site_city", "site_state", "screening_checklist",
        ],
    },
    "outreach_message": {
        "template_attr": "OUTREACH_MESSAGE_PROMPT",
        "required": [
            "nct_id", "brief_title", "site_name", "site_city", "site_state",
            "contact_name", "patient_summary", "match_score", "match_rationale",
        ],
    },
    "score_evaluation": {
        ...
        "required": [
            "cancer_type", "cancer_stage", "biomarkers", "prior_treatments",
            "lines_of_therapy", "age", "sex", "ecog_score",
            "nct_id", "brief_title", "eligibility_criteria",
            "initial_score", "initial_explanation", "criteria_json",
        ],
    },
}
...
def render_prompt(*, prompt_name: str, **variables) -> ToolResult:
    ...
    if not schema:
        return ToolResult(success=False, error=f"Unknown prompt: {prompt_name}. Available: {list(PROMPT_SCHEMAS.keys())}")
